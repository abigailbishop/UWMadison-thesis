...
Chapter~\ref{chap:intro} introduces the field of UHE neutrino observations and its place in multi-messenger astrophysics. 
A simulation study is then presented in Chapter~\ref{chap:gen2_infill} quantifying the benefits of joint Askaryan and Cherenkov emission observations in the proposed expansion of the IceCube Neutrino Observatory by placing radio antennas above planned optical modules. 
