...
\section{Removing Spoiled Data}
  ...
  \subsection{Spark Events}
    ...
    \begin{figure}
      \centering
      \includegraphics[width=0.6\textwidth]{sections/5sa-cleaning/images/A2_c7_spr.png}
  ...
  \subsection{Anomalous Channel Cut}
    ...
    \begin{figure}
      \centering
      \includegraphics[width=0.6\textwidth]{sections/5sa-cleaning/images/s4r3733e40469.png}
    ...
    \begin{figure}
      ...
      \begin{subfigure}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{sections/5sa-cleaning/images/a2c7_max_rms_corr_v.png}
      \end{subfigure}
      ~
      \begin{subfigure}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{sections/5sa-cleaning/images/a2c7_max_rms_corr_h.png}
      \end{subfigure}
      \begin{subfigure}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{sections/5sa-cleaning/images/a2c7_max_rms_ratio_v.png}
      \end{subfigure}
      ~
      \begin{subfigure}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{sections/5sa-cleaning/images/a2c7_max_rms_ratio_h.png}
      \end{subfigure}
  ...
  \subsection{Low Reconstruction Confidence Cut \label{sec:lrcc}}
    ...
    \begin{figure}
      \centering
      \includegraphics[width=0.75\textwidth]{sections/5sa-cleaning/images/a4_lrcc.png}
    ...
    \begin{figure}
      ...
      \begin{subfigure}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{sections/5sa-cleaning/images/a2c7_avg_snr_v.png}
      \end{subfigure}
      ~
      \begin{subfigure}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{sections/5sa-cleaning/images/a2c7_global_max_corr_v.png}
      \end{subfigure}
      \begin{subfigure}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{sections/5sa-cleaning/images/a2c7_impSig_v.png}
      \end{subfigure}
      ~
      \begin{subfigure}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{sections/5sa-cleaning/images/a2c7_corr_contrast_v.png}
      \end{subfigure}
...
\section{Removing Anthropogenic and Science Backgrounds}
  ...
  \subsection{Zenith Cut and Surface-Like Cut}
    ...
    \begin{figure}
      \centering
      \includegraphics[width=0.75\textwidth]{sections/5sa-cleaning/images/a1r3183e65990_mindepth.png}
...
\section{Quick Removal of Thermal-Like Events during 100\% Processing with the Fast Filter}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.75\textwidth]{sections/5sa-cleaning/images/a2c7_fastfilter.png}
