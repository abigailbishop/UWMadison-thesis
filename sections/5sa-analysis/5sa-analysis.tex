  ...
  \subsection{Study of Passing Events}
    ...
    \subsubsection{Results}
      ...
      \begin{figure}
        ...
        \caption{The voltage versus time waveforms in each A5 antenna for event 64066 of Run 2899, the A5 event corresponding to the PA event that passed the analysis.}
...
\section{Results from Analyzing the Full Data Sample \label{sec:5sa_results}}
    ...
    The \citep{feldman_cousins} 90\% confidence level upper limit factor relies on the number of observed events (0, for this analysis) and the number of expected backgrounds. 
    ...
    The \citep{feldman_cousins} 90\% confidence level upper limit factor on this analysis evaluates to 2.44 as the number of observed events is 0 and the expected number of backgrounds is 0.13.
