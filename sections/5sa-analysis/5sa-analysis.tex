  ...
  \subsection{Study of Passing Events}
    ...
    \subsubsection{Results}
      ...
      \begin{figure}
        ...
        \caption{
          The voltage versus time traces in each A5 antenna for event 89985 of Run 767, the PA event that passed the analysis.
          % This is bandpassed
        }
...
\section{Results from Analyzing the Full Data Sample \label{sec:5sa_results}}
    ...
    \begin{table}
      ...
      \end{tabular}
      \caption{Expected number of neutrino events expected at trigger level and at analysis level based on various astrophysical models, cosmogenic models, and experimental fluxes and upper limits.}
