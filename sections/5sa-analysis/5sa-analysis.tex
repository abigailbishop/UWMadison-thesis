...
\section{Post-Unblinding Analysis \label{sec:unblinding}}
  ...
  \subsection{Study of Passing Events}
    ...
    \subsubsection{Results}
      ...
      The \citep{ara_a23} analysis also discovered that 7 events of this nature in the 100\% dataset passed all analysis cuts which gave rise to the original Spark Event Cut\footnote{\url{https://aradocs.wipac.wisc.edu/cgi-bin/DocDB/ShowDocument?docid=2032}{https://aradocs.wipac.wisc.edu/cgi-bin/DocDB/ShowDocument?docid=2032}}.
